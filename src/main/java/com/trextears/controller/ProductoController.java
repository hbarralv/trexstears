...
public class ProductoController {
	...
	public String update(Producto producto, @RequestParam("img") MultipartFile file) throws IOException {
		...
		if(file.isEmpty()) { // Entramos en este if cuando editamos el producto sin cambiar la imagen.

			producto.setImagen(p.getImagen());
		}else {//Entramos en este if cuando editamos el producto y cambiamos la imagen
